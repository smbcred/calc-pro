  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        sm: [
          "clamp(0.875rem, 0.825rem + 0.25vw, 0.9375rem)",
          { lineHeight: "1.5" },
        ],
        base: [
        ...
        "3xl": [
          "clamp(1.75rem, 1.5rem + 1.25vw, 2.5rem)",
          { lineHeight: "1.25" },
        ],
      ...
      animation: {
        ...
        "recovery-bounce":
          "recoveryBounce 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) 0.5s forwards",
        successPulse: "successPulse 0.6s ease-out",
        completePulse: "completePulse 0.6s ease-out",
        celebrate: "celebrate 0.8s ease-out",
        "success-confetti":
          "confetti 0.8s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
        "checkmark-draw":
          "checkmarkDraw 0.6s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "button-bounce":
          "buttonBounce 150ms cubic-bezier(0.68, -0.55, 0.265, 1.55)",
        ...
        "chart-reveal":
          "chartReveal 700ms cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "bar-grow":
          "barGrow 500ms cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards",
        "number-pulse":
          "numberPulse 0.3s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
